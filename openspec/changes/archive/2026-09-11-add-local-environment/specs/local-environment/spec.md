...
La interfaz y la API SHALL servirse desde el mismo origen a través de un único punto de entrada. SHALL NOT existir un origen distinto por servicio, para que el navegador no distinga entre pedir la interfaz y pedir la API.
