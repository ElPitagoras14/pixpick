...
Una variante SHALL producirse la primera vez que se la pide, y las peticiones siguientes por la misma variante SHALL servirse de lo ya producido sin volver a transformar. SHALL NOT pre-generarse variantes al guardar la imagen.
